<?php
	...
	// If user is logged in, prefill shipping information from their profile
	$user_profile = [];
	...
	// Set user_id in the shipping session if user is logged in
	if(isset($_SESSION['user']) && !empty($_SESSION['user']['user_id'])) {
		$_SESSION['ship']['user_id'] = $_SESSION['user']['user_id'];
	}
